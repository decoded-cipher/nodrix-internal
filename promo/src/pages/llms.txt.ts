...
- [Products](${u('products')}): Libraries and tools around the core — the Arduino library, the MCP server, dashboard widgets, and the open device protocol.
...
- [MCP server](${u('products/mcp')}): Reference for the built-in Model Context Protocol server — the two endpoints, all 12 read and 16 write tools, the owner gating, and the registry listing.
