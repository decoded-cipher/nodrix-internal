// Entry for the local widget lab. Bundled to dist/widget-bundle.js (IIFE) so the
// static pages can load it over file:// with a plain <script> tag.
//
...
// their dynamic imports to CDN globals, and pages/chart.html / pages/map.html
// load those from a CDN. Paths reach up out of the submodule into the parent
// repo's shared package, so build this from a full monorepo checkout.
