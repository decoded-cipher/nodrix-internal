...
- iot-percent — A circular percentage ring that maps a value to 0–100%, with optional color thresholds that recolor the ring by value. Attributes: data-title, data-min, data-max, data-unit.
