...
Fetch the root CA for your host with `openssl` and paste the last certificate block into `secret.h`:
...
socket, use an ESP32, or ESP8266 in HTTP mode with a fingerprint.
